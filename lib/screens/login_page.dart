...
import 'package:loyalty_points/add_pro/add_product.dart';
import 'package:loyalty_points/screens/signup.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:loyalty_points/services/AuthUtil.dart';
          ...
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                //Addding some space between the logo and the inputs
                SizedBox(height: 80),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        ...
                        //Making the form fields slightly rounded for a more modern look
                        borderRadius: BorderRadius.all(Radius.circular(10.0)),
                      ),
